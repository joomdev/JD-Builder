...
namespace Joomdev\Component\JDBuilder\Administrator\View\Pages;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('Pages'), 'pages');

		$canDo = ContentHelper::getActions('com_jdbuilder', 'category');

		if ($canDo->get('core.create')) {
			$toolbar->addNew('page.add');
			$toolbar->standardButton('copy')
				->text('JTOOLBAR_DUPLICATE')
				->task('pages.duplicate')
				->listCheck(true);
		}
